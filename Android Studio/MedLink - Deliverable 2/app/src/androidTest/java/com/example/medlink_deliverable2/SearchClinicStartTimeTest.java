...
public class SearchClinicStartTimeTest {
    @Rule
    ...
    public void checkSearchClinic() throws Exception {
        assertNotNull(mActivity.findViewById(R.id.searchStartTime));
        EditText text = mActivity.findViewById(R.id.searchStartTime);
        text.setText("11:00");
        String startHET = text.getText().toString();
        assertEquals("11:00", startHET);
    }
}
