...
public class SearchForClinicTest {
    ...
    public void checkSearchClinic() throws Exception {
        assertNotNull(mActivity.findViewById(R.id.search_clinicName));
        EditText text = mActivity.findViewById(R.id.search_clinicName);
        text.setText("blue");
        String clinicName = text.getText().toString();
        assertEquals("blue", clinicName);
    }
